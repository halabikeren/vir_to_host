...
@click.option(
    ...
    type=click.Path(exists=True, file_okay=True, readable=True),
    help="path to annotations, extracted using ncbi annotations and annotations generated by vadr, already processed in the form of a csv file"
...
@click.option(
    "--map_positions_to_groupwise_aln",
    type=click.BOOL,
    help="indicator weather structures start and end positions from species-wise inference should be mapped to group-wise start and end positions",
    required=False,
    default=False,
)
def partition_secondary_structures(
    secondary_structures_df_path: str,
    grouping_field: str,
    ...
    log_path: str,
    df_output_path: str,
    map_positions_to_groupwise_aln: bool,
):
